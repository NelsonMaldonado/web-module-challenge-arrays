...
function addFlavor(array4,string){
  const  newarray = array4.unshift(string);
  return array4;
//    /*your code here*/
 }
...
function removeLastFlavor(array5){
    let newArray = array5.pop();
...
function getFlavorByIndex(array6,index){
    let pickMe = array6[index]    
    console.log(pickMe);  
    return pickMe;
